...
in Section 1 of this document:
    ...
    head(cohort_1)
    ##   id y        t age gender age_bin age_quart
    ## 1  1 0 25.00000  47      1       1         2
    ## 2  2 0 10.65152  58      0       0         3
    ## 3  3 0 25.00000  46      0       1         2
    ## 4  4 0 15.84131  52      0       0         3
    ## 5  5 0 22.57659  49      0       1         2
    ## 6  6 0 25.00000  63      0       0         4
